...
class Redmine_Client
{
     ...
     * @var bool
     */
    private $checkSslCertificate = 0;

    /**
     * @var bool
     */
    private $checkSslHost = 0;
    ...
    public function prepareRequest($path, $method = 'GET', $data = '')
    {
        ...
        if ($this->apikeyOrUsername && $this->useHttpAuth) {
            if (null === $this->pass) {
                ...
                //$this->setCurlOption(CURLOPT_USERNAME, $this->apikeyOrUsername);
                //$this->setCurlOption(CURLOPT_PASSWORD, $this->pass);
            }
